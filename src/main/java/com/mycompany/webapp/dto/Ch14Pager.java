...
public class Ch14Pager {
	private int totalRows;		//전체 행수, DB에서 모든 행을 가져와야한다.
	...
	private int pageNo;			//현재 페이지 번호, 사용자가 결정
	private int pagesPerGroup;	//그룹당 페이지 수 [이전]1,2,3,4,5[다음] 1~5가 그룹
